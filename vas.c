// OS Assignment 1: Clone Shell 'vas'
//Submitted by:
//Vikrant Chaugule(13CO152)
//A Sylendran(13CO154)
//Akshit Murthy(13CO155)
#include <stdio.h>
#include <unistd.h>
#include <sys/types.h>   //Definitions for datatypes like pid_t, pthread,etc.
#include <stdlib.h>
#include <string.h>
#include <signal.h>
#include <omp.h>  
...
// read one character of input, then discard up to the newline 
char readChar() 
{
    char c = getchar();
    while (getchar() != '\n');
